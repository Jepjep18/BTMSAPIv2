...
namespace BTMSAPI.Migrations
{
    ...
    [Migration("20250115070559_addedTireDisposedItemsModel")]
    partial class addedTireDisposedItemsModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BTMSAPI.Models.TireDisposedItems", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("TireReturnIds")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("TireDisposedItems");
                });
            ...
            modelBuilder.Entity("BTMSAPI.Models.TireReleasedItems", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("TireItemId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("TireItemId")
                        .IsUnique()
                        .HasFilter("[TireItemId] IS NOT NULL");

                    b.ToTable("TireReleasedItems");
                });

            modelBuilder.Entity("BTMSAPI.Models.TireReturnedItems", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("TireReleasedId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("TireReleasedId")
                        .IsUnique()
                        .HasFilter("[TireReleasedId] IS NOT NULL");

                    b.ToTable("TireReturnedItems");
                });
            ...
            modelBuilder.Entity("BTMSAPI.Models.TireReleasedItems", b =>
                {
                    b.HasOne("BTMSAPI.Models.TireItem", "TireItem")
                        .WithOne()
                        .HasForeignKey("BTMSAPI.Models.TireReleasedItems", "TireItemId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.Navigation("TireItem");
                });

            modelBuilder.Entity("BTMSAPI.Models.TireReturnedItems", b =>
                {
                    b.HasOne("BTMSAPI.Models.TireReleasedItems", "TireReleasedItems")
                        .WithOne()
                        .HasForeignKey("BTMSAPI.Models.TireReturnedItems", "TireReleasedId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.Navigation("TireReleasedItems");
                });
